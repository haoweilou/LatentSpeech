...
ljspeechtext = LJSpeechText(start=10100,end=10110,path=f"{root}LJSpeech/")
ljspeechaudio = LJSpeechAudio(start=10100,end=10110,path=f"{root}LJSpeech/",return_len=True)
