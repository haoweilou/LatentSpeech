...
path = "./save/duration/Baker_ALPHA.json"
...
dataset = BakerText(start=0,end=10,alphabet=True,path="L:/baker/")
sentence = dataset.hanzi[0]
audio_dataset = BakerAudio(0,10,"L:/baker/")
waveform = audio_dataset.audios[0]
print(waveform.shape)
hanzi = [i for i in sentence]
from ipa import hanzi_to_pinyin
words = [hanzi_to_pinyin(a)[0][:-1] for a in hanzi]
