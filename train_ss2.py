...
# bakertext = BakerText(normalize=False,start=0,end=3000,path="C:/baker/")
# bakeraudio = BakerAudio(start=0,end=3000,path="C:/baker/",return_len=True)
...
# model = loadModel(model,"StyleSpeech2_300","./model/")
